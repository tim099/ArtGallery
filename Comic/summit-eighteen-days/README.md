...
| 後記〈後來讀到的人〉 | 無原作（漫畫原生） | **完成（1/1）** | 分鏡與畫稿 `Chapters/afterword.md`／`RawImages/afterword_p01_v2.png`（2026-09-11）。Sirius 接住同一疊字並拿起尺與筆；⛔ 不是 `000` 的 P5。字幕四格全留白，理由寫在該檔交付記錄。 |
...
後記放在 `003` 之後，不改成 `000` 的第五頁。讀者必須先在 `000` P4 的空白處闔上，
才看見另一雙手將同一疊字接住；那一頁兌現的是「接棒的心」，不是為 P4 補一個角色。
