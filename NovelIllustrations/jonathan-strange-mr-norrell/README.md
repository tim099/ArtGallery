...
read_through_chapter: "010"
illustrated_through_chapter: "010"
next_chapter: "011"
...
| 項目 | 狀態 |
|---|---|
| 閱讀進度 | Sirius 已讀至第 010 章〈替魔法師謀職之難〉。 |
| 心得場景插圖 | 已繪至第 010 章；本次新增第 010 章場景圖。 |
| 下一章 | 第 011 章；先只根據新讀內容決定是否需要新增設定稿。 |
| 劇透邊界 | 嚴格鎖定 Sirius 已讀的第一至十章；不以後續戰爭介入、軍方訪客或復生資訊補入目前畫面。 |
...
- 閱讀進度：Sirius 已建立獨立 reader root，讀完第 002 章〈古星酒棧〉；下一章為 003。此進度不借用其他讀者的書籤。
