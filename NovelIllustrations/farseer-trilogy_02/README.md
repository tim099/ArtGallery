...
description: "meadow 依《皇家刺客》目前已讀至第九章建立的角色沿用、道具與場景參考；只鎖定前九章明示內容。"
author: "meadow (Codex)"
workflow: "AgentCommands/ArtGallery/NOVEL_ILLUSTRATION_WORKFLOW.md"
source_media: "book-farseer-trilogy_02"
read_through_chapter: "0009"
illustrated_through_chapter: "0009 (selected scenes; 0004 remains pending)"
next_chapter: "0010"
---
...
| 項目 | 狀態 |
|---|---|
| 閱讀進度 | 已讀至第 009 章〈防衛與牽繫〉。 |
| 心得場景插圖 | 已繪選擇性場景至第 009 章；第 004 章仍待補。 |
| 下一章 | 第 010 章。 |
| 劇透邊界 | 只鎖定前九章已明示的病夢、泥濘灣視野、弄臣照料、破曉出發、風雪歸途、公鹿堡馬廄、惟真談話與莫莉重逢、小狼的祕密照料、惟真地圖室的紅蠟標記與靜悄悄查訪、珂翠肯把復仇改造成辨認死者與共同悼念，以及耐辛的保護、風雪中的珂翠肯、小狼與蜚滋的雪地玩鬧；不補完襲擊真相、毒殺陰謀、後續王室事件、小狼的名字或命運，或未解的關係。 |
...
第一章的泥濘灣只以蜚滋的精技視野出現；紅船、火災與居民的死亡不可被當作一張可驗證的現實場景重畫，因此不建立泥濘灣街景或新的劫匪人物卡。弄臣的身分、預言能力與鼠頭權杖的用途仍只鎖定前三章可見行為，不替後續章節補完。第三章沒有新增設定卡：惟真與莫莉均沿用第一冊已存在的角色設定，場景圖選擇莫莉重逢的門邊距離，避免把未解的關係畫成和解。第五章的小狼已完成設定與心得場景圖，畫面將照顧保留為可退出的暫時庇護，而非馴服或既定歸屬。第六章的惟真地圖室已建立為可重複引用的場景設定；紅蠟標記只表示可疑襲擊，不能被解作真相。第八章新增珂翠肯人物設定，畫面只鎖定她以葬禮取代復仇的領導行動，不補完毒殺陰謀與後續王室事件。第九章沿用蜚滋與小狼設定，場景停在雪地玩鬧後的選擇，不把狼群或公鹿堡判成唯一正確的家。下一次開工先補第 004 章，再確認是否需要新增角色、道具或場景設定。
